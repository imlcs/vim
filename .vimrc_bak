...
func SetTitle() 
    if &filetype  == 'python'
		...
		call append(line(".")+2, "\#  Author: lcs") 
		call append(line(".")+3, "\#  Mail: liuchengsheng95@qq.com ") 
	...
	elseif &filetype == 'sh' 
		...
		call append(line(".")+1, "\# Author: lcs") 
		call append(line(".")+2, "\# mail: liuchengsheng95@qq.com") 
		"call append(line(".")+3, "\# Created Time: ".strftime("%c")) 
		call append(line(".")+3, "\# Created Time: ".strftime("%F %T")) 
		call append(line(".")+4, "\#########################################################################") 
		call append(line(".")+5, "") 
		call append(line(".")+6, "\#!/bin/bash") 
		call append(line(".")+7, "\set -x") 
		call append(line(".")+8, "\set -u") 
